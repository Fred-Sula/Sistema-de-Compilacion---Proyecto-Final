...
public class IDE extends JFrame {
	...
	private JButton btnReserved, btnIdentifiers, btnAnalizarTokens, btnCompilar;
	private JButton btnHtmlTokens, btnHtml;
	...
	private void initComponents() {
		...
		btnGuardar.addActionListener(e -> guardarArchivo());
		btnAbrir.addActionListener(e -> abrirArchivo());
		btnAnalizarTokens.addActionListener(e -> analizarTokens());
		...
		JButton[] botones = { btnNuevo, btnGuardar, btnAbrir, 
							  btnReserved, btnIdentifiers, btnAnalizarTokens, btnCompilar,
							  btnHtmlTokens, btnHtml };
